...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = getenv_value("PROJECT_NAME", "STARTER PROJECT")
    ...
    POSTGRES_USER: str = getenv_value("POSTGRES_USER", "starter")
    POSTGRES_PASSWORD: str = getenv_value("POSTGRES_PASSWORD", "starter")
    POSTGRES_DB: str = getenv_value("POSTGRES_DB", "starter_db")
    ...
    EMAILS_FROM_EMAIL: Optional[EmailStr] = getenv_value(
        "EMAILS_FROM_EMAIL", "starter@starter.labs"
    )
    EMAILS_FROM_NAME: Optional[str] = getenv_value("EMAILS_FROM_NAME", "starter")
    ...
    OTLP_SPAN_EXPORT_URL = getenv_value("OTLP_SPAN_EXPORT_URL", "http://localhost:4317")
